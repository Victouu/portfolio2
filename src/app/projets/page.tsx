...
const projets = [
  ...
  },
  {
    ...
    competences: ["C1", "C4", "C5", "C6"],
    github: "https://github.com/Victouu/A7-PACT",
    highlight: false,
  },
  {
    title: "MyBAD",
  ...
  },
  {
    ...
    date: "2024",
    description:
      "Application web interactive permettant d'explorer les données des pays du monde. Consommation d'API REST et affichage dynamique des informations.",
    tags: ["JavaScript", "HTML", "CSS", "API REST"],
    competences: ["C1", "C4"],
    github: "https://github.com/Victouu/Countries",
    highlight: false,
  },
  {
  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center overflow-x-hidden">
      <h1 className="sr-only">
        Projets de Victor Roué — Automatisation 5G, DevOps, développement
        full-stack
      </h1>
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex flex-wrap gap-1.5 mb-3">
                            {projet.competences.map((comp, compIndex) => (
                              <span
                                key={compIndex}
                                className="px-2 py-0.5 text-xs font-mono rounded bg-orange-500/20 text-orange-700 dark:text-orange-300 border border-orange-500/30"
                              >
                                {comp}
                              </span>
                            ))}
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex flex-wrap gap-1.5 mb-3">
                            {projet.competences.map((comp, compIndex) => (
                              <span
                                key={compIndex}
                                className="px-2 py-0.5 text-xs font-mono rounded bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-500/30"
                              >
                                {comp}
                              </span>
                            ))}
